...
public static class MVC {
    public static NsTasks.Web.Ui1.Controllers.AccountController Account = new NsTasks.Web.Ui1.Controllers.T4MVC_AccountController();
    public static NsTasks.Web.Ui1.Controllers.AsanaController Asana = new NsTasks.Web.Ui1.Controllers.T4MVC_AsanaController();
    public static NsTasks.Web.Ui1.Controllers.HomeController Home = new NsTasks.Web.Ui1.Controllers.T4MVC_HomeController();
...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static readonly string AjaxLogin_js_removed = Url("AjaxLogin.js_removed");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public static readonly string nsTasksAjax_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/nsTasksAjax.min.js") ? Url("nsTasksAjax.min.js") : Url("nsTasksAjax.js");
    ...
    public static class Content {
        ...
        public static class kendoui {
            ...
            public static readonly string nstasks_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/nstasks.min.css") ? Url("nstasks.min.css") : Url("nstasks.css");
                 
            public static readonly string nstasks_less = Url("nstasks.less");
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
